...
public class Sample_Main {
    public static void main(String[] args){
        String filePath = "SampleData_Mod.csv";
        //String filePath = "SampleData_Mod.csv";
        SCart tool = new SCart(filePath);
...
class SCart {
    ...
    private int numrows = 92695; //number of rows in data
    private int numvalidrows = 90218; //number of valid rows

    private int attrNum;
    private String filePath;
    private int NumPartition=4;

    private Float[][] data= new Float[numvalidrows][15];
    ...
    SAttrNode rootNode = new SAttrNode();

    public SCart(String filePath) {
    ...
    public void AddAttr(String[] tmp, int index){
        ...
        data[index][14]=(Float.parseFloat(tmp[16]));
    }
    ...
    public void buildDecisionTree(SAttrNode node, String parentAttrValue,
        ...
        for(int i=0; i<remainAttr.size();i++)
        {
            ...
            //System.out.println("Temp Gini: "+tempGini);
        ...
        SAttrNode[] childNode = new SAttrNode[2];
        Float[][] rData;
        ...
        for (int i = 0; i < bArray.length; i++) {
            ...
            for (int k = 0; k < rData.length; k++) {
                Integer index = rData[k][0].intValue();
            ...
            if(remainAttr!=null)
            {
                if (!sameClass) {
                    ...
                    //childNode[i].setsplitInfo(Float.parseFloat(SplitValue));
    ...
    public void accuracy_test()
    {
        Float accuracy = 0.0f;
        Integer matched = 0;
        SAttrNode pivot = rootNode;
        int startIndex = 0;  //search start index
        int endIndex = data.length;    //search end index
...
class SAttrNode {
    ...
    // Child Nodes
    private SAttrNode[] childAttrNode;
    // Data Record Index
    ...
    public void setChildAttrNode(SAttrNode[] ch)
    {
    ...
    public SAttrNode[] getChildAttrNode()
    {
